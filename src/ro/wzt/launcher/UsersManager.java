...
public class UsersManager {
	...
	public static final void removeUserFromList(final String username, final boolean fromLauncher) {
		...
		for(final ProfilesManager.LauncherProfile profile : ProfilesManager.getProfiles()) {
	...
	public static class User extends JSONObject {
		...
		public List<AuthUser.Property> properties;
		...
		public User(final String username, final String uuid, final String accountName, final boolean isOnline, final String accessToken, final List<AuthUser.Property> properties) {
			super(ObjectType.USER, uuid);
