...
public class LauncherConstants {
    ...
    public static final Font LAUNCHER_FONT = loadFontFromRes(Font.TRUETYPE_FONT, "/ro/wzt/launcher/res/Ubuntu-L.ttf", 13f);
    public static final Image LAUNCHER_ICON = loadImageFromRes("/ro/wzt/launcher/res/Icon.png");
    public static final Image LAUNCHER_IMAGE = loadImageFromRes("/ro/wzt/launcher/res/launcher-banner.png");
